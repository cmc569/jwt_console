...
class TransTicketRepository extends BaseRepository
{
    ...
    {
        $tickets = ProjectBurgerkingCouponChildLogs::select('project_burgerking_coupon_child_logs.created_at',
    ...
    public function getTickets_bak(Int $offset, Int $limit, String $filter=null, String $start_date=null, String $end_date=null)
    {
